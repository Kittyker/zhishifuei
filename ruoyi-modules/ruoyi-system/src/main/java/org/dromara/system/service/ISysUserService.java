...
public interface ISysUserService {
     ...
     * @return
     */
    int updateUserOpenId(SysUserBo user);
     ...
     * @return 结果
     */
    SysUserVo registerUser(SysUserBo user, String tenantId);

    SysUserVo queryUser(String openid, String phoneNumber);
    ...
    int updateUserByUserId(SysUserBo bo);
